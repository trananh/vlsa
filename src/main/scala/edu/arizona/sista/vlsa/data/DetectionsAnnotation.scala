...
import edu.arizona.sista.vlsa.data.DetectionsAnnotation.DetectionTypes.DetectionTypes
...
object DetectionsAnnotation {
  ...
  object DetectionTypes extends Enumeration {
    ...
    val Actions, Actors, Objects, Locations, Others = Value
  }
...
//      /** Introduce common synonyms extracted from a proximity-based thesaurus
//        * Website: http://webdocs.cs.ualberta.ca/~lindek/downloads.htm
//        */
//      case "child"      => return Array("child", "children", "boy", "girl", "infant", "baby", "daughter", "son",
//                                        "babies", "kids", "woman")
//      case "policeman"  => return Array("policeman", "policemen", "soldier", "policewoman", "cop", "guards", "soldiers",
//                                        "gunman", "police", "teenager", "officers")
